...
All models run on [OpenRouter](https://openrouter.ai) free tier. Toggle on/off before each run.
...
- [ ] **Ollama integration** — run local vision models (LLaVA, Moondream) without API keys
- [ ] **Image difficulty scoring** — rank images by how many models get them wrong
- [ ] **Reasoning feature extraction** — which visual features (bun, sausage, mustard) correlate with accuracy
- [ ] **Consistency testing** — same model, same image, multiple runs at temperature > 0
- [ ] **Prompt sensitivity** — does rewording the question swing accuracy by 20%?
...
[Silicon Valley](https://www.hbo.com/silicon-valley) (inspiration), [OpenRouter](https://openrouter.ai) (free models), [Pexels](https://www.pexels.com) (images), [shadcn/ui](https://ui.shadcn.com) (components)
